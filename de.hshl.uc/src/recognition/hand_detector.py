...
class hand_detector:
    ...
    def __init__(self, mode: object = False, maxHands: object = 1, detectionCon: object = 0.5, trackCon: object = 0.5, modelComplexity: object = 1) -> object:
        self.mode = mode
    ...
    def main(self):
        ...
        # video = str(video)
        #detector.runloop(detector)
        #t = Thread(target=detector.runloop(), args=())
        #t.start()
